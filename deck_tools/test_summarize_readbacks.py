...
"""
        ...
        self.assertEqual(result["barrier_bytes"], 1536)
        self.assertEqual(result["full_barrier_bytes"], 12288)
        self.assertEqual(result["barrier_scope_pct"], 12.5)
    ...
    def test_legacy_line_defaults_to_512_kib(self):
        ...
        self.assertEqual(intervals[0]["barrier_bytes"], 0)
        self.assertEqual(intervals[0]["full_barrier_bytes"], 0)
