...
private:
    struct ReadbackDownloadSample {
        ...
        u64 call_count{};
        u64 copy_count{};
        u64 barrier_span_bytes{};
        u64 barrier_buffer_bytes{};
    ...
    bool precise_readback_range_barrier{};
    ...
    u64 precise_readback_barrier_span_bytes{};
    u64 precise_readback_barrier_buffer_bytes{};
